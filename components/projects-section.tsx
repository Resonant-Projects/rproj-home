...
const projects = [
  {
    ...
    description: "My comprehensive site for all that I offer including daily learning and other resources.",
            ...
            <CardContent className="space-y-4">
              <div className="flex flex-wrap gap-2">
                {project.techStack.map((tech) => (
                  <Badge key={tech} variant="secondary" className="text-xs bg-secondary text-slate-50 px-2 py-1.5">
                    {tech}
                  </Badge>
                ))}
              </div>
              ...
              <div className="flex gap-2">
                {project.liveUrl && <Button size="sm" className="flex-1 bg-primary hover:bg-primary/90 text-primary-foreground" asChild>
