  ...
  return (
    <main className="min-h-screen bg-background relative overflow-x-hidden">
      ...
      <div className="relative z-10 mx-auto max-w-6xl px-6 md:px-10 pt-10 md:pt-16 pb-12">
        <nav className="mb-10 md:mb-16 flex items-center justify-between font-mono text-[10px] tracking-[0.25em] uppercase text-ink-500">
          ...
          <span className="hidden sm:inline">v4.0 · 2026</span>
        </nav>
